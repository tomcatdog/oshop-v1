...
<div class="content-box">
	<div class="content-box-content">
		...
		<div class="tab-content default-tab">
	    	<form action="<%=basePath %>admin/system/param/edit" method="post">
	    		<input type="hidden" id="id" name="id" value="${p.id }"/>
	            <table>
	            	<tr>
	            		<td><label for="paramName">参数名</label></td>
	            		<td>
	            			<input class="text-input input" type="text" id="paramName" name="paramName" value="${p.paramName }"/>
	            		</td>
            		</tr>
            		<tr>
	            		<td><label for="group">参数组</label></td>
	            		<td>
	            			<input class="text-input input" type="text" id="group" name="group" value="${p.group }"/>
            			</td>
	            	</tr>
	            	<tr>
	            		<td><label for="paramValue">参数值</label></td>
	            		<td><input class="text-input input" type="text" id="paramValue" name="paramValue" value="${p.paramValue }"/></td>
            		</tr>
            		<tr>
	            		<td><label for="paramgroup">是否允许修改</label></td>
	            		<td>
	            			<select name="modifiable" class="input">
			                	<option value="1" <c:if test="${p.modifiable == '1' }">selected="selected"</c:if>>是</option>
			                	<option value="0" <c:if test="${p.modifiable == '0' }">selected="selected"</c:if>>否</option>
	            			</select>
            			</td>
	            	</tr>
	            	<tr>
	            		...
	            		<td>
	            			<select name="init" class="input">
			                	<option value="1" <c:if test="${p.init == '1' }">selected="selected"</c:if>>是</option>
			                	<option value="0" <c:if test="${p.init == '0' }">selected="selected"</c:if>>否</option>
	            			</select>
            			</td>
	            	</tr>
	            	<tr>
	            		...
	            		<td>
	            			<textarea class="text-input input" id="remark" name="remark">${p.remark }</textarea>
	            		</td>
            		</tr>
	            	<tr>
	            		<td>
